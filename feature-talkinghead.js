...
// Set featured: true for DS99jlPCtaN
let updated = false;
arr.forEach(p => {
  if (p.permalink.includes('DS99jlPCtaN')) {
    p.featured = true;
    updated = true;
  }
});
...
if (updated) {
  ...
  console.log("Featured DS99jlPCtaN on homepage");
} else {
  console.log("Could not find DS99jlPCtaN");
}
